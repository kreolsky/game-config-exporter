...
Знакомая для боль? Тогда читайте дальше, в общих чертах расскажу как я справляюсь с этой болью, а если будет интерес, то расскажу в деталях и про сам подход и про подготовку к экспорту и про сам экспорт.
